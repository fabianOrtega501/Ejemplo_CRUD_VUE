        ...
        <div class="card-body">
          <form v-on:submit="editar">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" v-model="nombre" id="nombre" placeholder="Ingrese su nombre" requeride maxlength="50" class="form-control">
            </div>
            <div class="input-group mb-3">
              <span class="input-group-text"><i class="fa-solid fa-user"></i></span>
              <input type="text" v-model="apellido" id="apellido" placeholder="Ingrese su apellido" requeride maxlength="50" class="form-control">
            </div>
            <div class="input-group mb-3">
            ...
            <div class="d-grid col-6 mx-auto mb-3">
              <button class="btn btn-warning"><i class="fa-solid fa-floppy-refresh"></i> Guardar Cambios</button>
            </div>
          </form>
        </div>
      </div>
  ...
  export default{
    data(){
      return{
        ...
        apellido:'',
        foto:'',
        url:'http://localhost/cursos/ejemploCrud/public/api/v1/estudiantes',
        cargando:false
      }
    },
    mounted(){
